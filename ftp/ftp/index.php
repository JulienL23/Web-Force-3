...
$pdo = new PDO('mysql:host=localhost;dbname=id3141846_julienr', 'id3141846_julien', 'azerty2392', array(PDO::ATTR_ERRMODE => PDO::ERRMODE_WARNING, PDO::MYSQL_ATTR_INIT_COMMAND => 'SET NAMES utf8'));
