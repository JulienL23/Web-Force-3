...
Exemple 2 :
    ...
    Explication : On demande le membre eyant le pseudo vide et le MDP vide (n'existe pas) ou alors le membre dont l'id_membre est 2.
...
Exemple 3 :
    ...
    Explications :  On demande le membre ayant un le pseudo vide et le MDP vide (n'existe pas) ou alors 1=1
...
if (!empty($_POST)){
    ...
    if ($resultat -> rowCount() > 0) {// signifie que mon utilisateur existe, que le MDP et PSEUDO correspondent. On peut le connecter !!
        ...
        echo 'Félicitation , vous êtes connecté, voici vos informations de profil :';
        echo '<ul>';
