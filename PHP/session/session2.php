...
session_start(); // si un fichier de session existe et est lié à notre navigateur via l'cookie (PHPSESSID), alors il est ouvert, et les informations à l'intérieur sont accessible via la superglobale $_SESSION.
