...
// pas besoin de design (header, footer, contenu) sur cette page, car elle a seulement vocation à nous faire un traitement puis à nous rediriger vers l'affiche de tou les produits.
...
if (isset($_GET['id']) && !empty($_GET['id']) && is_numeric($_GET['id'])) {
    ...
    if ($resultat -> rowCount() > 0) { // signifie que le produit existes
