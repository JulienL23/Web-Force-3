...
if (!empty($_POST)) {
    ...
    // Si je suis dans le cadre d'une modification d'un produit on récupère le nom de l'ancienne photo... mais il se peut que l'utilisateur souhaite changer la photo, c'est donc le code ci-dessous qui prend le relais.
