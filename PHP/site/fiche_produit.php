...
// 3 : On va vérifier que l'id correspond bien a un produit existant sinon redirection vers Boutique
// 4 : On va afficherles infos du produit
// 5 : On gère le nombre de produits max à ajouter au panier
...
if (!empty($_POST)) {
	ajouterProduit($id_produit, $_POST['quantite'], $photo, $titre, $prix); // id, quantite, prix, photo, titre
...
<!-- <img src="photo/jaune.png" width="250" /> -->
